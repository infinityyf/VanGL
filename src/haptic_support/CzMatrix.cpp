...
//------------矩阵相乘------------------//
//--------------------------------------//
void MultiMatrix(float a[4][4],float b[4][4],float c[4][4])//矩阵c=a*b
{    
	for (int i=0;i<4;i++)
	{
		for (int j=0;j<4;j++)
...
void MultiMatrix_double(double a[4][4],double b[4][4],double c[4][4])//矩阵c=a*b
{    
	for (int i=0;i<4;i++)
	{
		for (int j=0;j<4;j++)
...
void MultiMatrixVector(float A[3][3], float B[3], float C[3])//C=A*B
{
	for (int i=0;i<3;i++){
		C[i] = 0;
		for (int j=0;j<3;j++){
