...
//	Skybox skybox(" ");
//	StandardShader test((path + "src\\shaders\\test.vs").c_str(), (path + "src\\shaders\\test.fs").c_str());
//
//
...
//
//	test.use();
//	test.setVector3("lightPos", glm::vec3(0.5f, 0.5f, 0.5f));
//
//	//get block index
...
//
//	unsigned int matrixIndex5 = glGetUniformBlockIndex(test.shaderProgramID, "Matrix");
//	glUniformBlockBinding(test.shaderProgramID, matrixIndex5, BIND_POINT::MATRIX_POINT);
//
...
//	Model ri(path + "scene\\models\\m2.obj");
//	ri.scale(glm::vec3(0.1f, 0.1f, 0.1f));
//	//PBR MODEL
...
//
//			test.use();
//			test.setVector3("viewPos", camera.cameraPos);
//			ri.drawModel(&test, cubeMap->envCubeMap);
//
