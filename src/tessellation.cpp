...
//
//	Camera camera(glm::vec3(0.5f, 0.0f, 2.0f), glm::vec3(0.0f, -0.5f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), 0.01f, 100.0f);
...
//	Texture terrainTex1((path + "scene\\materials\\terrain\\terrainTex1.jpg").c_str());
