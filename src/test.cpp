...
////rendering
//#include "camera.h"
//#include "model_loader/StandardModel.h"
...
//
//
//	//include material setting
//	BaseMaterial::createIncludeShaderFile((path + "src\\shaders\\includeShader\\baseLights.glsl").c_str());
//	BaseMaterial::createIncludeShaderFile((path + "src\\shaders\\includeShader\\baseFunctions.glsl").c_str());
//	BaseMaterial::createIncludeShaderFile((path + "src\\shaders\\includeShader\\baseVariables.glsl").c_str());
//
//	//data UBO
//	BaseMaterial::createUBOBinding();
//
//	//create program
//	unsigned int vertex = BaseMaterial::createShader((path + "src\\shaders\\StandardShader.vs").c_str(), VERTEX_SHADER);
//	unsigned int fragment = BaseMaterial::createShader((path + "src\\shaders\\StandardShader.fs").c_str(), FRAGMENT_SHADER);
//	
//	ForwardStandardMaterial material(vertex, fragment, NULL_SHADER, NULL_SHADER, NULL_SHADER);
//
//	//load model
//	StandardModel model(path + "scene\\models\\nanosuit_reflection\\nanosuit.obj");
//	
//
//	
//
//	//set light to material
//	shader.use();
...
//
//	
//	//load model bind material to model
...
//		glBindBuffer(GL_UNIFORM_BUFFER, 0);
//
//		glBindBuffer(GL_UNIFORM_BUFFER, BaseMaterial::MaterixUBO);
//		glBufferSubData(GL_UNIFORM_BUFFER, 0, 64, glm::value_ptr(camera.view));
//		glBufferSubData(GL_UNIFORM_BUFFER, 64, 64, glm::value_ptr(camera.projection));
//		glBufferSubData(GL_UNIFORM_BUFFER, 128, 4, &camera.nearPlane);
//		glBufferSubData(GL_UNIFORM_BUFFER, 132, 4, &camera.farPlane);
...
//
//		model.drawModel(&material,blackSkybox.skyBox, shadowMap->depthTexture);
//
//
